<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HelpFacturas.aspx.cs" Inherits="Views_Help_HelpFacturas" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <form id="form1" runat="server">
        ...
        <main role="main" class="container pt-4">
            ...
            <div class="card bg-light shadow rounded">
                <h5 class="card-header">Cómo ingresar una factura</h5>
                <div class="card-body">
                    <h6 class="card-title">Paso 1:</h6>
                    <p class="card-text">En la <b class="font-italic">barra de navegación</b> en la parte superior dar clic en la opción <b>Ingresar factura</b>.</p>
                    
                    <h6 class="card-title">Paso 2:</h6>
                    <p class="card-text">En la sección <b class="font-italic">1. Seleccionar un pedido</b> en la tabla donde se muestra el listado de los pedidos deberá seleccionar (marcar/check) el pedido o los pedidos que se van a facturar.</p>
                    
                    <h6 class="card-title">Paso 3:</h6>
                    <p class="card-text">Dar clic en la sección <b class="font-italic">2. Seleccionar los productos a facturar</b> en la tabla donde se muestra el listado de las partidas (productos/servicio) deberá seleccionar (marcar/check) las partidas que se van a facturar.</p>

                    <h6 class="card-title">Paso 4:</h6>
                    <p class="card-text">Dar clic en la sección <b class="font-italic">3. Seleccionar archivo XML</b>, deberá buscar y seleccionar su archivo XML que representa la factura que va crear en base a los pedidos seleccionados. Para buscar y seleccionar su archivo dar clic en el botón <b>Select</b>.</p>
                    <p class="card-text">
                        ...
                        En caso que no se cumplan estás condiciones el sistema rechazará el archivo y no podrá crear la factura.
                    </p>
                    ...
                    <p class="card-text">Al finalizar la validación se mostrará un mensaje informando si la validación es correcta o son incorrectas. <br />
                        Si las validaciones son incorrectas no podrá crear su factura hasta que se corrija el archivo XML timbrado.
                    </p>
                    ...
                    <h6 class="card-title">Paso 6:</h6>
                    <p class="card-text">Si las validaciones al archivo XML son correctas deberá dar clic en el botón <b>Crear Factura</b>.</p>
                    <p class="card-text">El proceso de crear la factura puede tardar unos segundos. Al Finalizar se mostrará el Folio/Número del documento de la factura creada.</p>

                    <p><a href="../Facturas/Registrar.aspx" class="a-link">Ingresar factura</a></p>
                </div>
            </div>
