<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Facturas.aspx.cs" Inherits="Views_Consultas_Facturas" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%--Consultar Facturas abiertas (pendientes de pago) page--%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <form id="form1" runat="server">
        ...
        <main role="main" class="container pt-2">
            ...
            <div class="card bg-light shadow rounded">
                <div class="card-header text-white bg-blue">Facturas pendientes de pago</div>
                <div class="card-body">
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" CssClass="" AutoGenerateColumns="False" OnItemDataBound="RadGrid1_ItemDataBound">
                            <MasterTableView AllowMultiColumnSorting="false">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn UniqueName="DocNum" HeaderText="No.Factura" DataField="DocNum" HeaderStyle-Width="80">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn UniqueName="DocDate" HeaderText="Fecha" DataField="DocDate">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn UniqueName="DocDueDate" HeaderText="Fecha vencimiento" DataField="DocDueDate">
                                    </telerik:GridBoundColumn>
