<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Entradas.aspx.cs" Inherits="Views_Consultas_Entradas" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%--Consultar Entradas de mercancias abiertas page--%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <form id="form1" runat="server">
        ...
        <main role="main" class="container pt-4">
            ...
            <div class="card bg-light shadow rounded">
                <div class="card-header text-white bg-blue">Entradas de mercancía abiertas</div>
                <div class="card-body">
                    <div class="table-responsive">
                        <telerik:RadGrid ID="RadGrid1" runat="server" CssClass="" AutoGenerateColumns="False" OnItemDataBound="RadGrid1_ItemDataBound">
                            <MasterTableView AllowMultiColumnSorting="true">
                                <Columns>
                                    <telerik:GridBoundColumn UniqueName="DocNumPedido" HeaderText="No.Pedido" DataField="DocNumPedido" HeaderStyle-Width="80">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn UniqueName="DocNum" HeaderText="No.Entrada" DataField="DocNum" HeaderStyle-Width="80">
                                    </telerik:GridBoundColumn>
